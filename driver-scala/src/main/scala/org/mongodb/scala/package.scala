...
package object scala extends ClientSessionImplicits with ObservableImplicits with WriteConcernImplicits {
  ...
  /** This object was generated by sbt-buildinfo. // todo */
  case object BuildInfo {
    /** The value is "mongo-scala-bson". */
    val name: String = "mongo-scala-bson"
    /** The value is "2.8.0-130-g1588df8-SNAPSHOT". */
    val version: String = "2.8.0-130-g1588df8-SNAPSHOT"
    /** The value is "2.13.0". */
