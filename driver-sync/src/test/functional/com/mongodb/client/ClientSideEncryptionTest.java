...
public class ClientSideEncryptionTest {
    ...
    public ClientSideEncryptionTest(final String filename, final String description, final BsonDocument specDocument, final BsonArray data,
    ...
    public void setUp() {
        ...
        extraOptions.put("mongocryptdSpawnArgs", Arrays.asList("--port", "28020"));
