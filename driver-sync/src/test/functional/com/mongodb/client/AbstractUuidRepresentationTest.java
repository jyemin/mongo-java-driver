...
public abstract class AbstractUuidRepresentationTest {
    ...
    AbstractUuidRepresentationTest(final UuidRepresentation uuidRepresentation, final BsonBinarySubType subType, final UUID uuid,
    ...
    @Before
    public void setUp() {
        createMongoClient(uuidRepresentation,
    ...
    public void shouldDecodeDbObjectWithUuidRepresentation() {
        ...
        DBObject document = dbObjectCollection.find().first();
        assertNotNull(document);
    ...
    public void shouldDecodePojoWithLegacyUuidRepresentation() {
        ...
        try {
            ...
            assertNotEquals(UuidRepresentation.JAVA_LEGACY, uuidRepresentation);
