...
public abstract class AbstractMqlValuesFunctionalTest extends OperationTest {
    ...
    protected void assertExpression(@Nullable final Object expected, final MqlValue mqlValue) {
        assertExpression(expected, mqlValue, null);
    }

    protected void assertExpression(@Nullable final Object expected, final MqlValue mqlValue, @Nullable final String expectedMql) {
        assertEval(expected, mqlValue);

        if (expectedMql == null) {
            return;
        }

        BsonValue expressionValue = ((MqlExpression<?>) mqlValue).toBsonValue(
    ...
    private void assertEval(@Nullable final Object expected, final MqlValue toEvaluate) {
    ...
    @Nullable
    protected BsonValue evaluate(final MqlValue toEvaluate) {
