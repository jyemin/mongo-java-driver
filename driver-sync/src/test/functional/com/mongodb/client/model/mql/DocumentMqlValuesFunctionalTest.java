...
class DocumentMqlValuesFunctionalTest extends AbstractMqlValuesFunctionalTest {
    ...
    private static MqlDocument ofDoc(final String ofDoc) {
        return of(BsonDocument.parse(ofDoc));
    }

    private final MqlDocument a1 = ofDoc("{a: 1}");
    private final MqlDocument ax1ay2 = ofDoc("{a: {x: 1, y: 2}}");
    ...
    public void getFieldTest() {
        ...
        MqlDocument doc = ofDoc("{a: {b: 2}, 'a.b': 3, 'a$b': 4, '$a.b': 5}");
    ...
    public void setFieldTest() {
        ...
        assertExpression(
                ...
                a1.setField("r", MqlValues.ofNull()),
