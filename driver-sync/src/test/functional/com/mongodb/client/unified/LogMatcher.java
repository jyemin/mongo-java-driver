...
final class LogMatcher {
    ...
    void assertLogMessageEquality(final String client, final BsonArray expectedMessages,
        ...
        for (int i = 0; i < expectedMessages.size(); i++) {
            valueMatcher.assertValuesMatch(expectedMessages.get(i).asDocument(), actualMessages.get(i).asDocument());
        }
