...
public final class NativeMongoCollection<TDocument> implements MongoCollection<TDocument> {
    ...
    @Override public ReadPreference getReadPreference() { return readPreference; }
    @Override public WriteConcern getWriteConcern() { return writeConcern; }
    @Override public ReadConcern getReadConcern() { return readConcern; }
    ...
    @Override public Publisher<Long> countDocuments(Bson filter, CountOptions options) {
        return Publishers.toMono(cb -> nativeClient.countDocuments(namespace, toBsonDocument(filter), options, null, cb));
    }
    ...
    @Override public Publisher<Long> countDocuments(ClientSession cs, Bson filter, CountOptions options) {
        return Publishers.toMono(cb -> nativeClient.countDocuments(namespace, toBsonDocument(filter), options, getNativeSession(cs), cb));
    }
    ...
    @Override public Publisher<Long> estimatedDocumentCount(EstimatedDocumentCountOptions options) {
        return Publishers.toMono(cb -> nativeClient.estimatedDocumentCount(namespace, options, cb));
    }
    ...
    @Override public <T> FindPublisher<T> find(Bson filter, Class<T> resultClass) {
        return new NativeFindPublisher<>(nativeClient, null, namespace, resultClass, codecRegistry).filter(filter);
    }
    ...
    @Override public <T> FindPublisher<T> find(ClientSession cs, Bson filter, Class<T> resultClass) {
        return new NativeFindPublisher<>(nativeClient, getNativeSession(cs), namespace, resultClass, codecRegistry).filter(filter);
    }
    ...
    @Override public <T> AggregatePublisher<T> aggregate(List<? extends Bson> p, Class<T> resultClass) {
        return new NativeAggregatePublisher<>(nativeClient, null, namespace.getDatabaseName(), namespace.getCollectionName(), p, resultClass, codecRegistry);
    }
    ...
    @Override public <T> AggregatePublisher<T> aggregate(ClientSession cs, List<? extends Bson> p, Class<T> resultClass) {
        return new NativeAggregatePublisher<>(nativeClient, getNativeSession(cs), namespace.getDatabaseName(), namespace.getCollectionName(), p, resultClass, codecRegistry);
    }
    ...
    @Override public <T> DistinctPublisher<T> distinct(String fieldName, Bson filter, Class<T> resultClass) {
        return new NativeDistinctPublisher<>(nativeClient, null, namespace, fieldName, resultClass, codecRegistry).filter(filter);
    }
    ...
    @Override public <T> DistinctPublisher<T> distinct(ClientSession cs, String fieldName, Bson filter, Class<T> resultClass) {
        return new NativeDistinctPublisher<>(nativeClient, getNativeSession(cs), namespace, fieldName, resultClass, codecRegistry).filter(filter);
    }
    ...
    @Override public Publisher<InsertOneResult> insertOne(TDocument document, InsertOneOptions options) {
        return Publishers.toMono(cb -> nativeClient.insertOne(namespace, documentToBson(document), options, null, cb));
    }
    ...
    @Override public Publisher<InsertOneResult> insertOne(ClientSession cs, TDocument document, InsertOneOptions options) {
        return Publishers.toMono(cb -> nativeClient.insertOne(namespace, documentToBson(document), options, getNativeSession(cs), cb));
    }
    ...
    @Override public Publisher<InsertManyResult> insertMany(List<? extends TDocument> documents, InsertManyOptions options) {
        ...
        return Publishers.toMono(cb -> nativeClient.insertMany(namespace, bsonDocs, options, null, cb));
    }
    ...
    @Override public Publisher<InsertManyResult> insertMany(ClientSession cs, List<? extends TDocument> documents, InsertManyOptions options) {
        List<BsonDocument> bsonDocs = documents.stream().map(this::documentToBson).collect(java.util.stream.Collectors.toList());
        return Publishers.toMono(cb -> nativeClient.insertMany(namespace, bsonDocs, options, getNativeSession(cs), cb));
    }
    ...
    @Override public Publisher<DeleteResult> deleteOne(Bson filter, DeleteOptions options) {
        return Publishers.toMono(cb -> nativeClient.deleteOne(namespace, filter, options, null, cb));
    }
    ...
    @Override public Publisher<DeleteResult> deleteOne(ClientSession cs, Bson filter, DeleteOptions options) {
        return Publishers.toMono(cb -> nativeClient.deleteOne(namespace, filter, options, getNativeSession(cs), cb));
    }
    ...
    @Override public Publisher<DeleteResult> deleteMany(Bson filter, DeleteOptions options) {
        return Publishers.toMono(cb -> nativeClient.deleteMany(namespace, filter, options, null, cb));
    }
    ...
    @Override public Publisher<DeleteResult> deleteMany(ClientSession cs, Bson filter, DeleteOptions options) {
        return Publishers.toMono(cb -> nativeClient.deleteMany(namespace, filter, options, getNativeSession(cs), cb));
    }
    ...
    @Override public Publisher<UpdateResult> replaceOne(Bson filter, TDocument replacement, ReplaceOptions options) {
        return Publishers.toMono(cb -> nativeClient.replaceOne(namespace, filter, documentToBson(replacement), options, null, cb));
    }
    ...
    @Override public Publisher<UpdateResult> replaceOne(ClientSession cs, Bson filter, TDocument replacement, ReplaceOptions options) {
        return Publishers.toMono(cb -> nativeClient.replaceOne(namespace, filter, documentToBson(replacement), options, getNativeSession(cs), cb));
    }
    ...
    @Override public Publisher<UpdateResult> updateOne(Bson filter, Bson update, UpdateOptions options) {
        return Publishers.toMono(cb -> nativeClient.updateOne(namespace, filter, update, options, null, cb));
    }
    ...
    @Override public Publisher<UpdateResult> updateOne(ClientSession cs, Bson filter, Bson update, UpdateOptions options) {
        return Publishers.toMono(cb -> nativeClient.updateOne(namespace, filter, update, options, getNativeSession(cs), cb));
    }
    ...
    @Override public Publisher<UpdateResult> updateMany(Bson filter, Bson update, UpdateOptions options) {
        return Publishers.toMono(cb -> nativeClient.updateMany(namespace, filter, update, options, null, cb));
    }
    ...
    @Override public Publisher<UpdateResult> updateMany(ClientSession cs, Bson filter, Bson update, UpdateOptions options) {
        return Publishers.toMono(cb -> nativeClient.updateMany(namespace, filter, update, options, getNativeSession(cs), cb));
    }
    ...
    @Override public Publisher<TDocument> findOneAndDelete(Bson filter, FindOneAndDeleteOptions options) {
        return Publishers.toMono(cb -> nativeClient.findOneAndDelete(namespace, filter, options, codecRegistry.get(documentClass), null, cb));
    }
    ...
    @Override public Publisher<TDocument> findOneAndDelete(ClientSession cs, Bson filter, FindOneAndDeleteOptions options) {
        return Publishers.toMono(cb -> nativeClient.findOneAndDelete(namespace, filter, options, codecRegistry.get(documentClass), getNativeSession(cs), cb));
    }
    ...
    @Override public Publisher<TDocument> findOneAndReplace(Bson filter, TDocument r, FindOneAndReplaceOptions options) {
        return Publishers.toMono(cb -> nativeClient.findOneAndReplace(namespace, filter, documentToBson(r), options, codecRegistry.get(documentClass), null, cb));
    }
    ...
    @Override public Publisher<TDocument> findOneAndReplace(ClientSession cs, Bson filter, TDocument r, FindOneAndReplaceOptions options) {
        return Publishers.toMono(cb -> nativeClient.findOneAndReplace(namespace, filter, documentToBson(r), options, codecRegistry.get(documentClass), getNativeSession(cs), cb));
    }
    ...
    @Override public Publisher<TDocument> findOneAndUpdate(Bson filter, Bson update, FindOneAndUpdateOptions options) {
        return Publishers.toMono(cb -> nativeClient.findOneAndUpdate(namespace, filter, update, options, codecRegistry.get(documentClass), null, cb));
    }
    ...
    @Override public Publisher<TDocument> findOneAndUpdate(ClientSession cs, Bson filter, Bson update, FindOneAndUpdateOptions options) {
        return Publishers.toMono(cb -> nativeClient.findOneAndUpdate(namespace, filter, update, options, codecRegistry.get(documentClass), getNativeSession(cs), cb));
    }
    ...
    @Override public Publisher<String> createIndex(Bson keys, IndexOptions options) {
        ...
        return Publishers.toMono(cb -> nativeClient.createIndex(namespace, keys, new CreateIndexOptions(), null, cb));
    }
    ...
    @Override public Publisher<String> createIndex(ClientSession cs, Bson keys, IndexOptions options) {
        // TODO: Copy timeout settings from IndexOptions to CreateIndexOptions if needed
        return Publishers.toMono(cb -> nativeClient.createIndex(namespace, keys, new CreateIndexOptions(), getNativeSession(cs), cb));
    }
    ...
    @Override public Publisher<String> createIndexes(List<IndexModel> indexes, CreateIndexOptions options) {
        return Publishers.<List<String>>toMono(cb -> nativeClient.createIndexes(namespace, indexes, options, null, cb)).flatMapMany(reactor.core.publisher.Flux::fromIterable);
    }
    ...
    @Override public Publisher<String> createIndexes(ClientSession cs, List<IndexModel> indexes, CreateIndexOptions options) {
        return Publishers.<List<String>>toMono(cb -> nativeClient.createIndexes(namespace, indexes, options, getNativeSession(cs), cb)).flatMapMany(reactor.core.publisher.Flux::fromIterable);
    }
    @Override public ListIndexesPublisher<Document> listIndexes() { return listIndexes(Document.class); }
    @Override public <T> ListIndexesPublisher<T> listIndexes(Class<T> resultClass) { return new NativeListIndexesPublisher<>(nativeClient, null, namespace, resultClass, codecRegistry); }
    @Override public ListIndexesPublisher<Document> listIndexes(ClientSession cs) { return listIndexes(cs, Document.class); }
    @Override public <T> ListIndexesPublisher<T> listIndexes(ClientSession cs, Class<T> resultClass) { return new NativeListIndexesPublisher<>(nativeClient, getNativeSession(cs), namespace, resultClass, codecRegistry); }
    ...
    @Override public Publisher<Void> dropIndex(String indexName, DropIndexOptions options) {
        return Publishers.toMonoVoid(cb -> nativeClient.dropIndex(namespace, indexName, options, null, cb));
    }
    ...
    @Override public Publisher<Void> dropIndex(Bson keys, DropIndexOptions options) {
        return Publishers.toMonoVoid(cb -> nativeClient.dropIndex(namespace, keys, options, null, cb));
    }
    ...
    @Override public Publisher<Void> dropIndex(ClientSession cs, String indexName, DropIndexOptions options) {
        return Publishers.toMonoVoid(cb -> nativeClient.dropIndex(namespace, indexName, options, getNativeSession(cs), cb));
    }
    ...
    @Override public Publisher<Void> dropIndex(ClientSession cs, Bson keys, DropIndexOptions options) {
        return Publishers.toMonoVoid(cb -> nativeClient.dropIndex(namespace, keys, options, getNativeSession(cs), cb));
    }
    ...
    @Override public Publisher<Void> drop(DropCollectionOptions options) {
        return Publishers.toMonoVoid(cb -> nativeClient.dropCollection(namespace, options, null, cb));
    }
    ...
    @Override public Publisher<Void> drop(ClientSession cs, DropCollectionOptions options) {
        return Publishers.toMonoVoid(cb -> nativeClient.dropCollection(namespace, options, getNativeSession(cs), cb));
    }
    ...
    @Override public Publisher<Void> renameCollection(MongoNamespace newNamespace, RenameCollectionOptions options) {
        return Publishers.toMonoVoid(cb -> nativeClient.renameCollection(namespace, newNamespace, options, null, cb));
    }
    ...
    @Override public Publisher<Void> renameCollection(ClientSession cs, MongoNamespace newNamespace, RenameCollectionOptions options) {
        return Publishers.toMonoVoid(cb -> nativeClient.renameCollection(namespace, newNamespace, options, getNativeSession(cs), cb));
    }
    ...
    @Override public <T> ChangeStreamPublisher<T> watch(List<? extends Bson> p, Class<T> resultClass) {
        return new NativeChangeStreamPublisher<>(nativeClient, null, p, resultClass, codecRegistry,
    ...
    @Override public <T> ChangeStreamPublisher<T> watch(ClientSession cs, List<? extends Bson> p, Class<T> resultClass) {
        return new NativeChangeStreamPublisher<>(nativeClient, getNativeSession(cs), p, resultClass, codecRegistry,
                NativeChangeStreamPublisher.WatchLevel.COLLECTION, namespace.getDatabaseName(), namespace.getCollectionName());
    }
