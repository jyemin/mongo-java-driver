...
public final class ProvidersCodecProvider implements CodecProvider {
    private final List<CodecProvider> codecProviders;

    public ProvidersCodecProvider(final List<? extends CodecProvider> codecProviders) {
    ...
    public boolean equals(final Object o) {
        ...
        ProvidersCodecProvider that = (ProvidersCodecProvider) o;
