 ...
 * concrete class that implements {@code Collection} and has a public no-args constructor. If the type argument is
 * {@code Collection<Object>}, {@code List<Object>}, {@code AbstractCollection<Object>}, or {@code AbstractList<Object>},
 * it constructs {@code ArrayList<Object>} instances when decoding. If the type argument is {@code Set<Object>} or
 * {@code AbstractSet<Object>}, it constructs {@code HashSet<Object>} instances when decoding. If the type argument is
