...
public class __darwin_pthread_handler_rec {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MongoDbFfi.C_POINTER.withName("__routine"),
        MongoDbFfi.C_POINTER.withName("__arg"),
        MongoDbFfi.C_POINTER.withName("__next")
    ...
    public static class __routine {
        ...
        private static final MethodHandle UP$MH = MongoDbFfi.upcallHandle(__routine.Function.class, "apply", $DESC);
