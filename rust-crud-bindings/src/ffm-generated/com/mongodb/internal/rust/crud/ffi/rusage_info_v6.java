...
public class rusage_info_v6 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(16, MongoDbFfi.C_CHAR).withName("ri_uuid"),
        MongoDbFfi.C_LONG_LONG.withName("ri_user_time"),
        MongoDbFfi.C_LONG_LONG.withName("ri_system_time"),
        MongoDbFfi.C_LONG_LONG.withName("ri_pkg_idle_wkups"),
        MongoDbFfi.C_LONG_LONG.withName("ri_interrupt_wkups"),
        MongoDbFfi.C_LONG_LONG.withName("ri_pageins"),
        MongoDbFfi.C_LONG_LONG.withName("ri_wired_size"),
        MongoDbFfi.C_LONG_LONG.withName("ri_resident_size"),
        MongoDbFfi.C_LONG_LONG.withName("ri_phys_footprint"),
        MongoDbFfi.C_LONG_LONG.withName("ri_proc_start_abstime"),
        MongoDbFfi.C_LONG_LONG.withName("ri_proc_exit_abstime"),
        MongoDbFfi.C_LONG_LONG.withName("ri_child_user_time"),
        MongoDbFfi.C_LONG_LONG.withName("ri_child_system_time"),
        MongoDbFfi.C_LONG_LONG.withName("ri_child_pkg_idle_wkups"),
        MongoDbFfi.C_LONG_LONG.withName("ri_child_interrupt_wkups"),
        MongoDbFfi.C_LONG_LONG.withName("ri_child_pageins"),
        MongoDbFfi.C_LONG_LONG.withName("ri_child_elapsed_abstime"),
        MongoDbFfi.C_LONG_LONG.withName("ri_diskio_bytesread"),
        MongoDbFfi.C_LONG_LONG.withName("ri_diskio_byteswritten"),
        MongoDbFfi.C_LONG_LONG.withName("ri_cpu_time_qos_default"),
        MongoDbFfi.C_LONG_LONG.withName("ri_cpu_time_qos_maintenance"),
        MongoDbFfi.C_LONG_LONG.withName("ri_cpu_time_qos_background"),
        MongoDbFfi.C_LONG_LONG.withName("ri_cpu_time_qos_utility"),
        MongoDbFfi.C_LONG_LONG.withName("ri_cpu_time_qos_legacy"),
        MongoDbFfi.C_LONG_LONG.withName("ri_cpu_time_qos_user_initiated"),
        MongoDbFfi.C_LONG_LONG.withName("ri_cpu_time_qos_user_interactive"),
        MongoDbFfi.C_LONG_LONG.withName("ri_billed_system_time"),
        MongoDbFfi.C_LONG_LONG.withName("ri_serviced_system_time"),
        MongoDbFfi.C_LONG_LONG.withName("ri_logical_writes"),
        MongoDbFfi.C_LONG_LONG.withName("ri_lifetime_max_phys_footprint"),
        MongoDbFfi.C_LONG_LONG.withName("ri_instructions"),
        MongoDbFfi.C_LONG_LONG.withName("ri_cycles"),
        MongoDbFfi.C_LONG_LONG.withName("ri_billed_energy"),
        MongoDbFfi.C_LONG_LONG.withName("ri_serviced_energy"),
        MongoDbFfi.C_LONG_LONG.withName("ri_interval_max_phys_footprint"),
        MongoDbFfi.C_LONG_LONG.withName("ri_runnable_time"),
        MongoDbFfi.C_LONG_LONG.withName("ri_flags"),
        MongoDbFfi.C_LONG_LONG.withName("ri_user_ptime"),
        MongoDbFfi.C_LONG_LONG.withName("ri_system_ptime"),
        MongoDbFfi.C_LONG_LONG.withName("ri_pinstructions"),
        MongoDbFfi.C_LONG_LONG.withName("ri_pcycles"),
        MongoDbFfi.C_LONG_LONG.withName("ri_energy_nj"),
        MongoDbFfi.C_LONG_LONG.withName("ri_penergy_nj"),
        MongoDbFfi.C_LONG_LONG.withName("ri_secure_time_in_system"),
        MongoDbFfi.C_LONG_LONG.withName("ri_secure_ptime_in_system"),
        MongoDbFfi.C_LONG_LONG.withName("ri_neural_footprint"),
        MongoDbFfi.C_LONG_LONG.withName("ri_lifetime_max_neural_footprint"),
        MongoDbFfi.C_LONG_LONG.withName("ri_interval_max_neural_footprint"),
        MemoryLayout.sequenceLayout(9, MongoDbFfi.C_LONG_LONG).withName("ri_reserved")
