...
/**
 * {@snippet lang=c :
 * typedef void (*ClientCallback)(void *, const struct ClientResult {
 *     struct MongoClient *client;
 * } *, const struct Error {
...
public class ClientCallback {
    ...
    private static final MethodHandle UP$MH = MongoDbFfi.upcallHandle(ClientCallback.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(ClientCallback.Function fi, Arena arena) {
