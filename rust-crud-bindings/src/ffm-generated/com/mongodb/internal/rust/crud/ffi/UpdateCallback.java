...
/**
 * {@snippet lang=c :
 * typedef void (*UpdateCallback)(void *, const struct UpdateResult {
...
public final class UpdateCallback {
    ...
    private static final MethodHandle UP$MH = MongoDbFfi.upcallHandle(UpdateCallback.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(UpdateCallback.Function fi, Arena arena) {
