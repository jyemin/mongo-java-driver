...
/**
 * {@snippet lang=c :
 * typedef void (*SessionCallback)(void *, const struct SessionResult {
 ...
 * }
 */
public final class SessionCallback {
    ...
    private static final MethodHandle UP$MH = MongoDbFfi.upcallHandle(SessionCallback.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(SessionCallback.Function fi, Arena arena) {
