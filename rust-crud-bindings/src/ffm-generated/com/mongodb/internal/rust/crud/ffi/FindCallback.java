...
/**
 * {@snippet lang=c :
 * typedef void (*FindCallback)(void *, const struct CursorResult {
 ...
 * }
 */
public final class FindCallback {
    ...
    private static final MethodHandle UP$MH = MongoDbFfi.upcallHandle(FindCallback.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(FindCallback.Function fi, Arena arena) {
