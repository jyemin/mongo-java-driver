...
/**
 * {@snippet lang=c :
 * typedef void (*DistinctCallback)(void *, const struct DistinctResult {
 *     const OwnedBsonValue *values;
 *     size_t len;
 * } *, const struct Error {
 *     uint8_t error_type;
...
public final class DistinctCallback {
    ...
    private static final MethodHandle UP$MH = MongoDbFfi.upcallHandle(DistinctCallback.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(DistinctCallback.Function fi, Arena arena) {
