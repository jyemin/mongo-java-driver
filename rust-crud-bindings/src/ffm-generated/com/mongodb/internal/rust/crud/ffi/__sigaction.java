...
public class __sigaction {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MongoDbFfi.C_POINTER.withName("sa_tramp"),
        MongoDbFfi.C_INT.withName("sa_mask"),
        MongoDbFfi.C_INT.withName("sa_flags")
    ...
    public static class sa_tramp {
        ...
        private static final MethodHandle UP$MH = MongoDbFfi.upcallHandle(sa_tramp.Function.class, "apply", $DESC);
