...
public class __darwin_arm_thread_state64 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(29, MongoDbFfi.C_LONG_LONG).withName("__x"),
        MongoDbFfi.C_LONG_LONG.withName("__fp"),
        MongoDbFfi.C_LONG_LONG.withName("__lr"),
        MongoDbFfi.C_LONG_LONG.withName("__sp"),
        MongoDbFfi.C_LONG_LONG.withName("__pc"),
        MongoDbFfi.C_INT.withName("__cpsr"),
        MongoDbFfi.C_INT.withName("__pad")
