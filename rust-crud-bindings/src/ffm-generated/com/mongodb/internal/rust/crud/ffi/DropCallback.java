 ...
 * }
 */
public final class DropCallback {
    ...
    private static final MethodHandle UP$MH = MongoDbFfi.upcallHandle(DropCallback.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(DropCallback.Function fi, Arena arena) {
