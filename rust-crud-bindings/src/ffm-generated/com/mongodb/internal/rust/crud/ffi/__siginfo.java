...
public class __siginfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MongoDbFfi.C_INT.withName("si_signo"),
        MongoDbFfi.C_INT.withName("si_errno"),
        MongoDbFfi.C_INT.withName("si_code"),
        MongoDbFfi.C_INT.withName("si_pid"),
        MongoDbFfi.C_INT.withName("si_uid"),
        MongoDbFfi.C_INT.withName("si_status"),
        MongoDbFfi.C_POINTER.withName("si_addr"),
        sigval.layout().withName("si_value"),
        MongoDbFfi.C_LONG.withName("si_band"),
        MemoryLayout.sequenceLayout(7, MongoDbFfi.C_LONG).withName("__pad")
    ).withName("__siginfo");
