...
public class __darwin_ucontext {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MongoDbFfi.C_INT.withName("uc_onstack"),
        MongoDbFfi.C_INT.withName("uc_sigmask"),
        __darwin_sigaltstack.layout().withName("uc_stack"),
        MongoDbFfi.C_POINTER.withName("uc_link"),
        MongoDbFfi.C_LONG.withName("uc_mcsize"),
        MongoDbFfi.C_POINTER.withName("uc_mcontext")
