...
public class BsonValue {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MongoDbFfi.C_CHAR.withName("bson_type"),
    ...
    private static final OfByte bson_type$LAYOUT = (OfByte)$LAYOUT.select(groupElement("bson_type"));
     ...
     * }
     */
    public static final OfByte bson_type$layout() {
     ...
     * }
     */
    public static final long bson_type$offset() {
        return bson_type$OFFSET;
    }
     ...
     * }
     */
    public static byte bson_type(MemorySegment struct) {
        return struct.get(bson_type$LAYOUT, bson_type$OFFSET);
    }
     ...
     * }
     */
    public static void bson_type(MemorySegment struct, byte fieldValue) {
        struct.set(bson_type$LAYOUT, bson_type$OFFSET, fieldValue);
    }
