...
/**
 * {@snippet lang=c :
 * typedef void (*DeleteCallback)(void *, const struct DeleteResult {
 ...
 * }
 */
public final class DeleteCallback {
    ...
    private static final MethodHandle UP$MH = MongoDbFfi.upcallHandle(DeleteCallback.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(DeleteCallback.Function fi, Arena arena) {
