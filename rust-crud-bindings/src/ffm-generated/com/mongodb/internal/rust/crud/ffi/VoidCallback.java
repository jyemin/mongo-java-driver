...
/**
 * {@snippet lang=c :
 * typedef void (*VoidCallback)(void *, const struct Error {
...
public final class VoidCallback {
    ...
    private static final MethodHandle UP$MH = MongoDbFfi.upcallHandle(VoidCallback.Function.class, "apply", $DESC);
