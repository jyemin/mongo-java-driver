 ...
 * }
 */
public final class DestroyCallback {
    ...
    private static final MethodHandle UP$MH = MongoDbFfi.upcallHandle(DestroyCallback.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(DestroyCallback.Function fi, Arena arena) {
