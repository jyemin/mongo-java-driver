...
/**
 * {@snippet lang=c :
 * typedef void (*CommandCallback)(void *, const struct CommandResult {
...
public class CommandCallback {
    ...
    private static final MethodHandle UP$MH = MongoDbFfi.upcallHandle(CommandCallback.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(CommandCallback.Function fi, Arena arena) {
