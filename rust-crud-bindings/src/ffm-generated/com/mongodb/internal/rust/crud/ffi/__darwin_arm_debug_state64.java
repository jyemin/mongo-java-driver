...
public class __darwin_arm_debug_state64 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(16, MongoDbFfi.C_LONG_LONG).withName("__bvr"),
        MemoryLayout.sequenceLayout(16, MongoDbFfi.C_LONG_LONG).withName("__bcr"),
        MemoryLayout.sequenceLayout(16, MongoDbFfi.C_LONG_LONG).withName("__wvr"),
        MemoryLayout.sequenceLayout(16, MongoDbFfi.C_LONG_LONG).withName("__wcr"),
        MongoDbFfi.C_LONG_LONG.withName("__mdscr_el1")
