...
/**
 * {@snippet lang=c :
 * typedef void (*TransactionCallback)(void *, const struct Error {
 *     uint8_t error_type;
...
public final class TransactionCallback {
    ...
    private static final MethodHandle UP$MH = MongoDbFfi.upcallHandle(TransactionCallback.Function.class, "apply", $DESC);
