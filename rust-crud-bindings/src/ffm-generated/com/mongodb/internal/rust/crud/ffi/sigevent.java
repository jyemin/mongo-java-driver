...
public class sigevent {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MongoDbFfi.C_INT.withName("sigev_notify"),
        MongoDbFfi.C_INT.withName("sigev_signo"),
        sigval.layout().withName("sigev_value"),
        MongoDbFfi.C_POINTER.withName("sigev_notify_function"),
        MongoDbFfi.C_POINTER.withName("sigev_notify_attributes")
    ).withName("sigevent");
    ...
    public static class sigev_notify_function {
        ...
        private static final MethodHandle UP$MH = MongoDbFfi.upcallHandle(sigev_notify_function.Function.class, "apply", $DESC);
