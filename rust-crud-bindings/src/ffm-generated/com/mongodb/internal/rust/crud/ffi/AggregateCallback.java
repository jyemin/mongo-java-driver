...
/**
 * {@snippet lang=c :
 * typedef void (*AggregateCallback)(void *, const struct CursorResult {
...
public final class AggregateCallback {
    ...
    private static final MethodHandle UP$MH = MongoDbFfi.upcallHandle(AggregateCallback.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(AggregateCallback.Function fi, Arena arena) {
