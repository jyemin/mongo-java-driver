...
package com.mongodb.internal.pool;
...
import static com.mongodb.internal.pool.ConcurrentPool.INFINITE_SIZE;
import static com.mongodb.internal.pool.ConcurrentPool.lockInterruptibly;
import static com.mongodb.internal.pool.ConcurrentPool.lockUnfair;
import static com.mongodb.internal.pool.ConcurrentPool.sizeToString;
...
class DefaultConnectionPool implements ConnectionPool {
     ...
     */
    public DefaultConnectionPool(final ServerId serverId, final InternalConnectionFactory internalConnectionFactory,
    ...
    public ConcurrentPool<UsageTrackingInternalConnection> getPool() {
        return pool;
    }
