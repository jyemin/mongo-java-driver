...
class BulkWriteBatchCombiner {
     ...
     */
    BulkWriteBatchCombiner(final ServerAddress serverAddress, final boolean ordered, final WriteConcern writeConcern) {
     ...
     */
    void addResult(final BulkWriteResult result) {
     ...
     */
    void addErrorResult(final MongoBulkWriteException exception, final IndexMap indexMap) {
     ...
     * @param indexMap   the index map
     */
    void addWriteErrorResult(final BulkWriteError writeError, final IndexMap indexMap) {
     ...
     */
    void addWriteConcernErrorResult(final WriteConcernError writeConcernError) {
     ...
     * @param indexMap          the index map
     */
    void addErrorResult(final List<BulkWriteError> writeErrors,
     ...
     */
    boolean shouldStopSendingMoreBatches() {
