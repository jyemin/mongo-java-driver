...
final class OperationHelper {
    ...
    private static void validateWriteRequestHint(final WriteConcern writeConcern, final WriteRequest request) {
    ...
    static void validateWriteRequestHints(final List<? extends WriteRequest> requests, final WriteConcern writeConcern) {
        for (WriteRequest request : requests) {
            Bson hint = null;
            ...
            if (hint != null || hintString != null) {
                validateWriteRequestHint(writeConcern, request);
                break;
            }
        }
    }
