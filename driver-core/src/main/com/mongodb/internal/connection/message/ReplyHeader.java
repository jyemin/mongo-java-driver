...
import static com.mongodb.internal.connection.message.OpCode.OP_MSG;
import static com.mongodb.internal.connection.message.OpCode.OP_REPLY;
...
public final class ReplyHeader {
    ...
    public ReplyHeader(final ByteBuf header, final MessageHeader messageHeader) {
        this(messageHeader.getMessageLength(), messageHeader.getOpCode(), messageHeader, header);
    }

    public ReplyHeader(final ByteBuf header, final CompressedHeader compressedHeader) {
