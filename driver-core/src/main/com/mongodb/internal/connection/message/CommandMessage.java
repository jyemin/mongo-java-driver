...
package com.mongodb.internal.connection.message;
...
import static com.mongodb.internal.connection.message.BsonWriterHelper.writePayload;
...
public final class CommandMessage extends RequestMessage {
    ...
    public CommandMessage(final MongoNamespace namespace, final BsonDocument command, final FieldNameValidator commandFieldNameValidator,
    ...
    public BsonDocument getCommandDocument(final ByteBufferBsonOutput bsonOutput) {
