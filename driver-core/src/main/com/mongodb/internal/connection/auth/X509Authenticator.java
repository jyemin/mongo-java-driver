...
public class X509Authenticator extends Authenticator implements SpeculativeAuthenticator {
    ...
    public X509Authenticator(final MongoCredentialWithCache credential, final ClusterConnectionMode clusterConnectionMode,
    ...
    public void authenticate(final InternalConnection connection, final ConnectionDescription connectionDescription) {
        ...
        try {
            ...
            CommandHelper.executeCommand(getMongoCredential().getSource(), authCommand, getClusterConnectionMode(), getServerApi(), connection);
