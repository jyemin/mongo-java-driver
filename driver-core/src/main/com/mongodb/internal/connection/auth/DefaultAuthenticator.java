...
package com.mongodb.internal.connection.auth;
...
public class DefaultAuthenticator extends Authenticator implements SpeculativeAuthenticator {
    public static final int USER_NOT_FOUND_CODE = 11;
    ...
    public DefaultAuthenticator(final MongoCredentialWithCache credential, final ClusterConnectionMode clusterConnectionMode,
    ...
    @Override
    public void authenticateAsync(final InternalConnection connection, final ConnectionDescription connectionDescription,
