...
public class UnmonitoredClusterableServerFactory implements ClusterableServerFactory {
    ...
    public UnmonitoredClusterableServerFactory(final ClusterId clusterId, final ClusterSettings clusterSettings,
    ...
    public ClusterableServer create(final ServerAddress serverAddress,
        ...
        return new UnmonitoredServer(serverAddress, clusterClock, connectionPool, new DefaultConnectionFactory());
    }
