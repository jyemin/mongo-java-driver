...
package com.mongodb.internal.connection.protocol;
...
public class CommandProtocolImpl<T> implements CommandProtocol<T> {
    ...
    public CommandProtocolImpl(final String database, final BsonDocument command, final FieldNameValidator commandFieldNameValidator,
